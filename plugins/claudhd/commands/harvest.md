...
2. **Drop anything already handled.** Skip ideas already in IDEAS.md, already in NOW.md's Queue, or already shipped in SHIPPED.md. Also skip ideas that were raised and then explicitly rejected or abandoned later in the conversation.
